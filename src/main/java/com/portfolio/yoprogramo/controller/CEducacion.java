...
import com.portfolio.yoprogramo.model.Educacion;
...
public class CEducacion {
    ...
    public ResponseEntity<?> create(@RequestBody dtoEducacion dtoedu) {
        ...
        Educacion educacion = new Educacion(dtoedu.getNombreE(), dtoedu.getDescripcionE(),dtoedu.getFechaE(),dtoedu.getUrlE());
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoEducacion dtoedu) {
        ...
        educacion.setUrlE(dtoedu.getUrlE());
